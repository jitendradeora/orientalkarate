...
export function Booking() {
  ...
  const classes = [
    {
      id: "kids",
      name: "Children (5-14 years)",
      description: "Fun and engaging classes for young martial artists",
    },
    {
      id: "adults",
      name: "Adults (15-60 years)",
      description: "Comprehensive training for teens and adults",
    },
    {
      id: "kubudo",
      name: "Kobudo (Martial Arts Weapons)",
      description: "Martial Arts Weapons",
    },
  ];
              ...
              <div className="flex justify-between items-center mb-4">
                {stepLabels.map((label, i) => (
                  <div key={i} className="flex flex-col items-center flex-1">
                    ...
                    <span
                      className={`text-xs font-medium ${i + 1 <= getStepNumber() ? "text-gray-900" : "text-gray-400"}`}
                    >
                      {label}
                    </span>
                  </div>
                ...
                >
                  <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                    ...
                    <div>
                      ...
                      >
                        WhatsApp number{" "}
                        <span className="text-[#eb0339]">*</span>
                      </label>
                      <input
                        type="tel"
                        id="whatsapp"
              ...
              >
                ...
                <div className="mb-6 rounded-2xl border border-gray-100 bg-gray-50 p-6 text-left">
                  ...
                  <div className="space-y-3 text-gray-700">
                    ...
                    <p>
                      ...
                      {
                        getAvailableDates().find((d) => d.id === selectedDate)
                          ?.display
                      }
                    </p>
                    <p>
                ...
                <div className="mb-8 rounded-2xl border border-gray-100 bg-gray-50 p-6 text-gray-700">
                  <p className="mb-2 text-lg">
                    A confirmation message will be sent to you via WhatsApp
                    shortly.
                  </p>
                  <p className="text-sm text-gray-600">
                    Please arrive 10 minutes early and wear comfortable
                    clothing.
                  </p>
            ...
            >
              ...
              <button
                ...
                disabled={
                  ...
                  (currentStep === "userInfo" &&
                    (!fullName || !email || !whatsapp || !numKids || !address))
                }
                className={`inline-flex items-center gap-2 rounded-full px-6 py-3.5 font-semibold transition-all duration-300 ${
                  (currentStep === "branch" && !selectedBranchId) ||
                  (currentStep === "class" && !selectedClass) ||
